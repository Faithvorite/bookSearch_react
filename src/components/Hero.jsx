...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col space-y-2 mt-12 bg-[rgb(255,136,106)] h-800px'>
        <div className="mr-3 font-bold text-4xl sm:text-6xl font-logo text-white p-5">the {text}</div>
       <SearchForm />
